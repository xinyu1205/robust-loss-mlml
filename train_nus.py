...
parser = argparse.ArgumentParser(description='PyTorch Nus_wide Training')
parser.add_argument('--train_dataset', help='select dataset', default='./dataset/nus_train_single.txt')
parser.add_argument('--val_dataset', help='select dataset', default='./dataset/nus_val.txt')
parser.add_argument('--data', metavar='DIR', help='path to dataset', default='/home/NUS_wide/')
...
def main():
    ...
    data_path_val   = f'{args.data}images'    # args.data
    data_path_train = f'{args.data}images'  # args.data

    val_dataset = COCO_missing_dataset(data_path_val,
                                instances_path_val,
                                transforms.Compose([
